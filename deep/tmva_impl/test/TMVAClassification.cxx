...
int main( int argc, char** argv )
{
   ...
   factory->AddVariable( "myvar1 := var0+var1", 'F' );
   factory->AddVariable( "myvar2 := var0-var1", "Expression 2", "", 'F' );
...
//       TString layoutString ("Layout=RELU|(N+100)*2,LINEAR");
   ...
   std::cout << "train all methods" << std::endl;
   factory->TrainAllMethods();

   // ---- Evaluate all MVAs using the set of test events
   std::cout << "test all methods" << std::endl;
