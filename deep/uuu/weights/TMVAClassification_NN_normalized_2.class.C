...
Method         : NN::NN_normalized_2
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.05/01       [394497]
Creator        : peters
Date           : Wed Jul 29 10:51:14 2015
...
Layout: "TANH|100,TANH|50,LINEAR" [neural network layout]
...
class ReadNN_normalized_2 : public IClassifierReader {

 public:

   // constructor
   ReadNN_normalized_2( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadNN_normalized_2" ),
        fNvars( 43 ),
        fIsNormalised( false )
   {      
 ...
 private:
   ...
   inline double ReadNN_normalized_2::GetMvaValue( const std::vector<double>& inputValues ) const
   {
...
inline void ReadNN_normalized_2::InitTransform_1()
{
...
//_______________________________________________________________________
inline void ReadNN_normalized_2::Transform_1( std::vector<double>& iv, int cls) const
{
...
//_______________________________________________________________________
inline void ReadNN_normalized_2::InitTransform()
{
   InitTransform_1();
}

//_______________________________________________________________________
inline void ReadNN_normalized_2::Transform( std::vector<double>& iv, int sigOrBgd ) const
{
