...
#            print "q=",q,"  a[i]=",a[i],"  y[i]=",y[i],"  rho[i]=", rho[i]
            q -= a[i] * y[i]
#        print "0: a: ",a
#        print "1: q: ",q
...
#        print "2: z: ",z
    ...
    def determine_step(self, dr):
        ...
        """
#        print "dr=",dr,"  (dr**2)=",(dr**2),"   (dr**2).sum(1)=",((dr**2).sum(1))
        steplengths = (dr**2).sum(1)
        longest_step = np.max(steplengths)
        longest_step = longest_step**0.5
