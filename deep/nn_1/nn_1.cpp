...
public:
	...
	DropContainer dropContainer;
	    ...
	    // execute training cycle
            NNTYPE trainError = trainCycle (minimizer, weights, begin (trainPattern), end (trainPattern), settings, dropContainer);
...
//            std::cout << "forward" << std::endl;
    ...
    NNTYPE errorFunction (LayerData& layerData, Container truth, ItWeight itWeight, ItWeight itWeightEnd, double patternWeight, double factorWeightDecay) const
    {
	NNTYPE error (0);
...
//    MaxGradWeight minimizer;
    ClassificationSettings settings (/*_convergenceSteps*/ 150, /*_batchSize*/ 30, /*_testRepetitions*/ 7, 
				     /*factorWeightDecay*/ 1.0e-5, /*isL1Regularization*/ false, 
				     /*dropFraction*/ 0.3, /*dropRepetitions*/ 7, /*scaleToNumEvents*/0);
...
//    MaxGradWeight minimizer (1e-5, 3);
    ...
    ClassificationSettings settings (/*_convergenceSteps*/ 150, /*_batchSize*/ 70, /*_testRepetitions*/ 7, 
				     ...
				     /*dropFraction*/ 0.3, /*dropRepetitions*/ 1, /*scaleToNumEvents*/ 550000);
    ...
    ClassificationSettings settings2 (/*_convergenceSteps*/ 150, /*_batchSize*/ 70, /*_testRepetitions*/ 7, 
				     /*factorWeightDecay*/ 0.0, /*isL1*/false, 
    ...
    /*double E = */net.train (weights, trainPattern, testPattern, minimizer, settings2);
